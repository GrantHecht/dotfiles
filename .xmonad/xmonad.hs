...
myStartupHook :: X ()
myStartupHook = do
          setWMName "LG3D" -- Required for MATLAB
          spawnOnce "lxsession &"
	  spawnOnce "autorandr --change normal &"
...
myWorkspaces = [" res ", " www ", " hw ", " doc ", " zoom ", " main ", " mus ", " vid ", " extra "]
...
myKeys =
    ...
    -- Useful programs to have a keybinding for launch
        ...
        , ("M-b", spawn (myBrowser ++ " https://ublearns.blackboard.com/?new_loc=%2Fultra%2Fcourse"))
...
main = do
    ...
    xmproc0 <- spawnPipe "xmobar -x 0 $HOME/.config/xmobar/xmobar0.config"
    ...
    xmonad $ ewmh def
        ...
        , logHook = workspaceHistoryHook <+> myLogHook <+> dynamicLogWithPP xmobarPP
                        ...
                        , ppVisible = xmobarColor "#A6E22E" "" . clickable              -- Visible but not current workspace
                        , ppHidden = xmobarColor "#AE81FF" "" . wrap "*" "" . clickable -- Hidden workspaces in xmobar
                        , ppHiddenNoWindows = xmobarColor "#AE81FF" ""  . clickable     -- Hidden workspaces (no windows)
                        , ppTitle = xmobarColor "#F9F8F5" "" . shorten 60               -- Title of active window in xmobar
                        , ppSep =  "<fc=#666666> <fn=1>|</fn> </fc>"                    -- Separators in xmobar
                        , ppUrgent = xmobarColor "#F92672" "" . wrap "!" "!"            -- Urgent workspace
